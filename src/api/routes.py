...
def add_routes(
    ...
    if add_admin_app:
        add_all_admin_resources_routes(api_router, admin_routes_dependencies, secure_cookies)

    add_non_admin_routes(api_router, api_routes_dependencies, samesite, secure_cookies)
