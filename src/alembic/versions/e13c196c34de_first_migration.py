...
Revision ID: e13c196c34de
Revises: 
Create Date: 2022-10-05 16:16:38.572357
...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_user_email_verifications_id'), 'user_email_verifications', ['id'], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_user_email_verifications_id'), table_name='user_email_verifications')
