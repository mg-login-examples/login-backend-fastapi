...
def get_router(user_route_dependencies: UserRouteDependencies) -> APIRouter:
    ...
    @router.get('/{user_note_id}', response_model=UserNote,
                response_model_by_alias=False,
                dependencies=[
                    user_route_dependencies.current_user  # type: ignore
                ]
                )
    async def get_user_note(user_note_id: str,
    ...
    verify_create_user_note_owner_dependency = get_verify_create_user_note_owner_as_fastapi_dependency(
    ...
    verify_edit_user_note_owner_dependency = get_verify_edit_user_note_owner_as_fastapi_dependency(
    ...
    verify_delete_user_note_owner_dependency = get_verify_delete_user_note_owner_as_fastapi_dependency(
        user_route_dependencies.mongo_db, user_route_dependencies.current_user)
