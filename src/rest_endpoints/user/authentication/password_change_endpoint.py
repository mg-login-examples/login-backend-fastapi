...
from data.schemas.http_error_exceptions.http_400_exceptions import HTTP_400_BAD_REQUEST_EXCEPTION, HTTP_400_INVALID_PASSWORD_EXCEPTION
from data.schemas.http_error_exceptions.http_401_exceptions import HTTP_401_INVALID_CREDENTIALS_EXCEPTION
    ...
    async def change_user_password(
        ...
        try:
            ...
            if not verify_password(
                    user_password_change.password, user.hashed_password):
            ...
            user.hashed_password = get_password_hash(
                user_password_change.password_new)
