...
def get_router(user_route_dependencies: UserRouteDependencies) -> APIRouter:
    ...
    verify_create_quote_owner_dependency = get_verify_create_quote_owner_as_fastapi_dependency(
    ...
    verify_delete_quote_owner_dependency = get_verify_delete_quote_owner_as_fastapi_dependency(
    ...
    verify_edit_quote_owner_dependency = get_verify_edit_quote_owner_as_fastapi_dependency(
        user_route_dependencies.sql_db_session, user_route_dependencies.current_user)
