...
from admin.data.schemas.quotes.quoteCreateAsModel import QuoteCreateAsModel as QuoteCreateAsModelSchema
from admin.data.schemas.quotes.quoteDeep import Quote as QuoteDeepSchema
from admin.data.schemas.quotes.quoteUpdateAsModel import QuoteUpdateAsModel as QuoteUpdateAsModelSchema
