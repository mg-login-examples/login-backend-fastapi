...
class RedisBackend:
    ...
    async def connect(self) -> None:
        ...
        # next line is required for redis - subscribe to any channel before starting to listen to published messages
        dummy_channel = ''.join(random.choices(string.ascii_lowercase + string.digits, k=20))
