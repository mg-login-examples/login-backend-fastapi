...
def test_resend_email_unverified_user(mock_add_task: MagicMock, logged_in_unverified_user: User, test_client: requests.Session, test_app_db_manager: SQLAlchemyDBManager):
...
@patch("fastapi.BackgroundTasks.add_task")
def test_resend_email_verified_user(mock_add_task: MagicMock, test_client_logged_in: requests.Session, logged_in_user: User, test_app_db_manager: SQLAlchemyDBManager):
...
@patch("fastapi.BackgroundTasks.add_task")
def test_verify_email(mock_add_task: MagicMock, logged_in_unverified_user: User, test_client: requests.Session, test_app_db_manager: SQLAlchemyDBManager):
