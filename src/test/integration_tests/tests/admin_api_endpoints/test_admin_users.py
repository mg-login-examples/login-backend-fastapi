...
def test_get_user(test_client_admin_logged_in: requests.Session, created_user_by_admin: UserDeep):
    user = users_admin_api.get_user(test_client_admin_logged_in, created_user_by_admin.id)
...
def test_put_user(test_client_admin_logged_in: requests.Session, created_user_by_admin: UserDeep):
...
def test_delete_user(test_client_admin_logged_in: requests.Session, created_user_by_admin: UserDeep):
    users_admin_api.delete_user(test_client_admin_logged_in, created_user_by_admin.id)
    users_admin_api.get_user_expect_not_found(test_client_admin_logged_in, created_user_by_admin.id)
