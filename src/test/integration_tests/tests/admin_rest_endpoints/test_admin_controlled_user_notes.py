...
def test_get_user_note(test_client: requests.Session, created_user_note_by_admin: UserNote):
    user_note = user_notes_admin_api.get_user_note(test_client, str(created_user_note_by_admin.id))
...
def test_create_user_note(test_client: requests.Session, created_user_by_admin: User):
    user_note_to_create = generate_random_user_note_to_create(created_user_by_admin.id)
    created_user_note = user_notes_admin_api.create_user_note(test_client, user_note_to_create)
...
def test_put_user_note(test_client_admin_logged_in: requests.Session, created_n_users_by_admin: List[UserDeep], created_user_note_by_admin: UserNote):
    ...
    user_notes_admin_api.put_user_note(test_client_admin_logged_in, created_user_note_by_admin)
    user_note = user_notes_admin_api.get_user_note(test_client_admin_logged_in, str(created_user_note_by_admin.id))
...
def test_delete_user_note(test_client_admin_logged_in: requests.Session, created_user_note_by_admin: UserNote):
    user_notes_admin_api.delete_user_note(test_client_admin_logged_in, str(created_user_note_by_admin.id))
    user_notes_admin_api.get_user_note_expect_not_found(test_client_admin_logged_in, str(created_user_note_by_admin.id))
