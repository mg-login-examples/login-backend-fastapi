...
def create_user_note(
    test_client: requests.Session, user_note_to_create: UserNoteCreate
) -> UserNote:
...
def put_user_note(test_client: requests.Session, user_note_to_edit: UserNote):
    response = test_client.put(
        f"/api/admin/resource/user-notes/{user_note_to_edit.id}/",
        json=jsonable_encoder(user_note_to_edit),
    )
...
def get_user_note_expect_not_found(test_client: requests.Session, user_note_id: str):
    response = test_client.get(f"/api/admin/resource/user-notes/{user_note_id}/")
