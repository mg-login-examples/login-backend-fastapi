...
def test_get_quotes(
    test_client: requests.Session, created_n_quotes_by_admin: list[QuoteDeep]
):
...
def test_delete_quote(
    test_client_admin_logged_in: requests.Session, created_quote_by_admin: QuoteDeep
):
