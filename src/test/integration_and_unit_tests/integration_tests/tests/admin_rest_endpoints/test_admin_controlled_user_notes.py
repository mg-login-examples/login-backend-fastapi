...
def test_get_user_note(
    test_client: requests.Session, created_user_note_by_admin: UserNote
):
...
def test_get_user_notes(
    test_client: requests.Session, created_n_user_notes_by_admin: list[UserNote]
):
