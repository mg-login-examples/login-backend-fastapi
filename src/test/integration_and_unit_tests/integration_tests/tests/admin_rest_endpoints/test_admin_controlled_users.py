...
def test_get_user(test_client_admin_logged_in: requests.Session,
...
def test_create_user(test_client_admin_logged_in: requests.Session):
    ...
    created_user = users_admin_api.create_user(
        test_client_admin_logged_in, user)
...
def test_get_users(test_client_admin_logged_in: requests.Session,
...
def test_put_user(test_client_admin_logged_in: requests.Session,
                  created_user_by_admin: UserDeep):
    assert created_user_by_admin.is_active
    created_user_by_admin.is_active = False
    users_admin_api.put_user(
        test_client_admin_logged_in, created_user_by_admin)
    user = users_admin_api.get_user(
        test_client_admin_logged_in, created_user_by_admin.id)
...
def test_delete_user(test_client_admin_logged_in: requests.Session,
                     created_user_by_admin: UserDeep):
    users_admin_api.delete_user(
        test_client_admin_logged_in, created_user_by_admin.id)
