...
@pytest.fixture
async def async_test_client(event_loop: AbstractEventLoop, app: FastAPI, app_pubsub: PubSub) -> AsyncClient:
    ...
    async with AsyncClient(app=app, base_url="http://test") as client:
        ...
        # Otherwise get Error 'Task was destroyed but it is pending!' & 'Event loop is closed' in PubSub _listener task
