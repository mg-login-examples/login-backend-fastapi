...
@pytest.fixture
def created_user_note(test_client_logged_in: requests.Session,
                      logged_in_user: User) -> UserNote:
...
@pytest.fixture
def created_n_user_notes(test_client_logged_in: requests.Session,
                         logged_in_user: User, n_user_notes: int = 5) -> list[UserNote]:
