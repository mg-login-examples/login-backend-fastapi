...
class ResourceListViewScreen:
    ...
    def navigate_to_last_page_button(self):
        return PageSelectorHelper(
            self.page, self.navigate_to_last_page_button_selector, self.navigate_to_last_page_button_desc)
    ...
    def create_new_item_button(self):
        return PageSelectorHelper(
            self.page, self.create_new_item_button_selector, self.create_new_item_button_desc)
