...
class UserNotesListViewScreen:
    def __init__(self, page: Page, base_url: str,
        ...
        self.view_url = ViewUrlHelper(
            base_url + "/admin/resource/user-notes/", "User Notes List Page", page, user_name=user_name)
    ...
    def user_notes_resources_title(self):
        return PageSelectorHelper(
            self.page, self.user_notes_resources_title_selector, self.user_notes_resources_title_desc)
