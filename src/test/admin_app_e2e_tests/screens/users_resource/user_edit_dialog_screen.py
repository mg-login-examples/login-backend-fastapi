...
class UserUpdateDialogScreen:
    ...
    update_user_dialog_selector = "[data-test='items--update-item-dialog']:has-text('Update User')"
    @property
    def update_user_dialog(self):
        return PageSelectorHelper(self.page, self.update_user_dialog_selector, self.update_user_dialog_desc)

    user_email_input_desc = "User Email Input"
    user_email_input_selector = "[data-test='items--update-item-dialog'] [data-test='items--item-email--input']"
    @property
    ...
    update_user_button_selector = "[data-test='items--update-item-dialog--update']"
    @property
    def update_user_button(self):
        return PageSelectorHelper(self.page, self.update_user_button_selector, self.update_user_button_desc)
