...
class UserCreateDialogScreen:
    ...
    new_user_dialog_selector = "[data-test='items--create-item-dialog']:has-text('Create User')"
    @property
    ...
    user_email_input_selector = "[data-test='items--create-item-dialog'] [data-test='items--item-email--input']"
    @property
    ...
    user_password_input_selector = "[data-test='items--create-item-dialog'] [data-test='items--item-password--input']"
    @property
    ...
    create_user_button_selector = "[data-test='items--create-item-dialog--create']"
    @property
