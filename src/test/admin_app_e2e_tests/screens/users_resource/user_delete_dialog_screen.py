...
class UserDeleteDialogScreen:
    ...
    def delete_user_message_desc(user_designation: str):
        return f"Delete message for user with name or email '{
            user_designation}'s"

    @staticmethod
    def delete_user_message_selector(user_designation: str):
        return f"[test-id='items--delete-item-dialog--delete-message']:has-text('{
            user_designation}')"

    def delete_user_message(self, user_designation: str):
        return PageSelectorHelper(self.page, UserDeleteDialogScreen.delete_user_message_selector(
            user_designation), UserDeleteDialogScreen.delete_user_message_desc(user_designation))
