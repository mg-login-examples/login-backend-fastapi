...
class PageSelectorHelper:
    ...
    def click(self, position: Position = None, delay: int = None, timeout: int = None):
        step_desc = f"User '{self.user_name}' click on '{self.selector_desc}'"
        @allure.step(step_desc)
        def step_wrapper():
            logger.info(step_desc)
            self.page.locator(self.selector).click(position=position, delay=delay, timeout=timeout)
        step_wrapper()

    def hover(self, position: Position = None, timeout: int = None):
    ...
    def clear(self, delay: int = None, timeout: int = None):
        step_desc = f"User '{self.user_name}' clear field '{self.selector_desc}'"
        @allure.step(step_desc)
        def step_wrapper():
            logger.info(step_desc)
            self.page.locator(self.selector).clear(delay=delay, timeout=timeout)
        step_wrapper()

    def check_if_visible(self, timeout: int = None):
    ...
    def check_if_not_visible(self, timeout: int = None):
    ...
    def expect_not_to_be_visible(self, timeout = None):
        step_desc = f"User '{self.user_name}' expect '{self.selector_desc}' not to be visible"
        @allure.step(step_desc)
        def step_wrapper():
            logger.info(step_desc)
    ...
    def check_if_enabled(self, timeout: int = None):
    ...
    def expect_to_be_enabled(self, timeout = None):
        step_desc = f"User '{self.user_name}' expect '{self.selector_desc}' to be enabled"
        @allure.step(step_desc)
        def step_wrapper():
            logger.info(step_desc)
    ...
    def check_if_disabled(self, timeout: int = None):
    ...
    def expect_to_be_disabled(self, timeout = None):
        step_desc = f"User '{self.user_name}' expect '{self.selector_desc}' to be disabled"
        @allure.step(step_desc)
        def step_wrapper():
            logger.info(step_desc)
    ...
    def check_if_checked(self, timeout: int = None):
    ...
    def expect_to_be_checked(self, timeout = None):
        step_desc = f"User '{self.user_name}' expect '{self.selector_desc}' to be checked"
        @allure.step(step_desc)
        def step_wrapper():
            logger.info(step_desc)
    ...
    def expect_not_to_be_checked(self, timeout = None):
        step_desc = f"User '{self.user_name}' expect '{self.selector_desc}' not to be checked"
        @allure.step(step_desc)
        def step_wrapper():
            logger.info(step_desc)
