...
def test_create_new_user(admin_user: AdminUser):
    ...
    admin_user.with_user_resource_tasks().create_basic_user(test_user_email, test_password)
    admin_user.on_users_list_view().user_with_email(test_user_email).expect_to_be_visible()
...
def test_edit_user(admin_user: AdminUser):
    ...
    admin_user.on_user_update_dialog().user_email_input.expect_to_have_value(test_user_email)
    ...
    admin_user.on_user_update_dialog().user_email_input.expect_to_have_value(test_user_email_updated)
    ...
    admin_user.on_users_list_view().user_with_email(test_user_email).expect_not_to_be_visible()
    admin_user.on_users_list_view().user_with_email(test_user_email_updated).expect_to_be_visible()
...
def test_delete_user(admin_user: AdminUser):
    ...
    admin_user.on_user_delete_dialog().delete_user_message(test_user_email).expect_to_be_visible()
